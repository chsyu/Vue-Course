...
const todoTemplate = todos =>
  ...
  const footerTemplate = todo => `
			<span class="todo-count"><strong>${todo.activeTodoCount}</strong> ${todo.activeTodoWord} left</span>
			<ul class="filters">
				<li>
					<a class="${(todo.filter == "all") ? "selected" : ""}" href="#/all">All</a>
				</li>
				<li>
					<a class="${(todo.filter == "active") ? "selected" : ""}" href="#/active">Active</a>
				</li>
				<li>
					<a class="${(todo.filter=='completed') ? 'selected':''}" href="#/completed">Completed</a>
				</li>
			</ul>
			${todo.completedTodos?'<button class="clear-completed">Clear completed</button>':''}
  `;
